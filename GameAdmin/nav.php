...
<nav>
    <ul>
        ...
        ?>
        <li><a href="../shopPage.php?cart">Cart</a></li>
        <?php
        if($_SESSION['Role'] == "Admin") {
            ...
            echo "<div class='dropdown-content' style='right:0'>";
                echo "<a href='newitem.php'>Create</a>";
                echo "<a href='retrieval.php'>Read</a>";
                echo "<a href='updateStart.php'>Update</a>";
                echo "<a href='delStart.php'>Delete</a>";
            echo "</div>";
        echo "</li>";
        }
        ?>
